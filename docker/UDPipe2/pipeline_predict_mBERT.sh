...
echo "=== [STEP 2] Computing wembeddings for test sets (mBERT) ==="
...
for corpus in "${CORPORA[@]}"; do
  compute_wemb "datasets/${corpus}/test.conllu"
done
...
# 4. Predict with all trained mBERT models
echo "=== [STEP 4] Running predictions for all mBERT models ==="
