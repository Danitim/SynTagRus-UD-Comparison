...
rm -rf .venv-wemb-mmbert-old/
uv venv --python 3.12 .venv-wemb-mmbert-old

source .venv-wemb-mmbert-old/bin/activate
...
echo "=== [STEP 2] Computing wembeddings for corpora: ud-old, str-old ==="
...
echo "=== [ALL DONE] Corpora: ud-old, str-old — models in models/UDPipe2/${WEMB_MODEL_TAG}/ ==="
exec bash
